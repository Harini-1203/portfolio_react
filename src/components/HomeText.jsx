...
const HomeText = () => {
  return (
    <div className='flex flex-col  justify-center md:w-auto lg:pr-50  '>
    
      <p class='md:text-4xl sm:text-xl font-mono'>Hello I'm</p>
      ...
      <div className='w-full flex md:justify-center sm:justify-start items-center'>
        <button className='cursor-pointer border-2 md:w-25 text-s rounded-lg shadow-2xl bg-[#8b60f7] text-white p-2 md:mt-10 mt-3 hover:bg-[#6b46c1] hover:shadow-xl'>
